...
const Checkout = () => {
  ...
  const validateForm = () => {
    ...
    if (paymentMethod === 'card') {
      ...
      if (!cardRegex.test(cleanCardNumber)) errors.cardNumber = 'Valid 16-digit card number is required';
      if (!expiryRegex.test(formData.expiryDate)) errors.expiryDate = 'Valid expiry date (MM/YY) is required';
      ...
      <div className="checkout-page">
        <div className="success-container">
          ...
          <div className="success-message">
            ...
            <p className="success-thankyou">Thank you for your purchase. You will receive a confirmation email shortly.</p>
              ...
              {paymentMethod === 'cod' && (
                <div className="cod-info">
                  <div className="info-box">
                    ...
                    <p>Pay when your order arrives. A unique payment code will be generated for verification.</p>
                  </div>
                </div>
              )}
            </div>
            ...
            {items.map(item => (
              <div key={item.id} className="order-item">
                ...
                <div className="item-details">
                  <h4>{item.name}</h4>
                  <p className="item-price">${((item.price || 0) * (item.quantity || 0)).toFixed(2)}</p>
                </div>
              </div>
            ))}
          </div>
